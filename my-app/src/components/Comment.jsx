...
const Comment = ({rev}) => {
  ...
  return (
    <div className='font-medium w-72'>
        <div>
            <div className='flex rounded-t-xl p-2 justify-start flex-row bg-blue-800/75 '>
            ...
            <div className='flex flex-row items-center'>
                ...
                <p className='text-3xl mb-2  text-white'><i class="fa-regular fa-star"></i></p>
                <p className='text-2xl font-bold text-white'>{rev.rating}</p>
                </div>

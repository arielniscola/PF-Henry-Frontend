...
import { ButtonReturn, Generalcontainer } from "./styles";
import clientAxios from "../../config/clientAxios";

const AddPermissionMercadopago = () => {
  ...
  console.log(process.env.REACT_APP_ID, ".env")
...
export default AddPermissionMercadopago;
